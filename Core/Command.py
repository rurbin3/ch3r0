...
def modules():
	print "\n"
	print "\t\033[93m[+] \033[92mch3r0 Gathering Modules\033[33m$\033[91m>"
	print "\n"
	...
	print "\n"
	print "\t\033[93m[+] \033[92mch3r0 Hash Modules\033[33m$\033[91m>"
	print "\n"
	...
	print "\n"
	print "\t\033[93m[+] \033[92mch3r0 Scanner Modules\033[33m$\033[91m>"
	print "\n"
	print "\033[93mCommand: " + colored("     \t\033[96mDescription")
