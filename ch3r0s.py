...
import sys
print "--------------------------------------------------------------------------------------------------"
print """\033[93m!WELCOME TO THE SECURE VERSION OF ch3r0 WHAT THIS MEANS IS THAT
THE ch3r0 WILL BE RUN WITH PROXYCHAINS AND OTHER TOOLS MAKING YOU NEAR ANONYMOUS EXITING 
...
h = raw_input("?: ")
if h == "n":
	print "follow \033[92m@c.y.b.e.r.b.y.t.e\033[0m on instagram"
	sys.exit()
if h == "y":
	...
	os.system(show)
	print "\nSTARTING ch3r0 WITH PROXYCHAINS\n"
	os.system("proxychains python /root/ch3r0/ch3r0.py")
	print "\033[93m------------------------\033[0m"
	print "\nSTOPPING MACCHANGER\n"
	print "\033[93m------------------------\033[0m"
	os.system("iwconfig")
